...
def test_get_llm_no_key_raises_valueerror_openrouter():
    ...
    from voidaccess.llm_utils import _make_openrouter_llm

    with patch("voidaccess.llm_utils.OPENROUTER_API_KEY", None):
...
def test_get_llm_no_key_raises_valueerror_groq():
    ...
    from voidaccess.llm_utils import _make_groq_llm

    with patch("voidaccess.llm_utils.GROQ_API_KEY", None):
...
def test_get_llm_no_key_raises_valueerror_openai():
    ...
    from voidaccess.llm_utils import _make_openai_llm

    with patch("voidaccess.llm_utils.OPENAI_API_KEY", None):
...
def test_get_llm_no_key_raises_valueerror_anthropic():
    ...
    from voidaccess.llm_utils import _make_anthropic_llm

    with patch("voidaccess.llm_utils.ANTHROPIC_API_KEY", None):
